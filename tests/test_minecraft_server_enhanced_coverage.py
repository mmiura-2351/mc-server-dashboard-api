...
class TestMinecraftServerManagerEnhanced:
    ...
    @pytest.mark.asyncio
    async def test_start_server_process_monitoring_with_error_output(
        self, manager, mock_server
    ):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            type(mock_process).returncode = property(
                lambda self: returncode_side_effect()
            )
                                ...
                                with patch.object(
                                    ...
                                    with patch(
                                        ...
                                        success_calls = [
                                            ...
                                            if "Process verification successful"
                                            in str(call)
                                        ]
