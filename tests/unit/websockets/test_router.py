...
class TestWebSocketRouter:
    ...
    async def test_websocket_server_logs_success(self, mock_ws_service, mock_auth, mock_websocket, mock_user, mock_db_session):
    ...
    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    async def test_websocket_server_logs_auth_error(self, mock_auth, mock_websocket, mock_db_session):
    ...
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.websocket_service')
    async def test_websocket_server_logs_internal_error(self, mock_ws_service, mock_auth, mock_websocket, mock_user, mock_db_session):
        ...
        mock_websocket.close.assert_called_once_with(code=1011, reason="Internal error: Internal error")

    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.websocket_service')
    async def test_websocket_server_status_success(self, mock_ws_service, mock_auth, mock_websocket, mock_user, mock_db_session):
    ...
    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    async def test_websocket_server_status_auth_error(self, mock_auth, mock_websocket, mock_db_session):
    ...
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.websocket_service')
    async def test_websocket_server_status_internal_error(self, mock_ws_service, mock_auth, mock_websocket, mock_user, mock_db_session):
        ...
        mock_websocket.close.assert_called_once_with(code=1011, reason="Internal error: Service error")

    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.datetime')
    async def test_websocket_notifications_success_ping_pong(self, mock_datetime, mock_auth, mock_websocket, mock_user, mock_db_session):
        ...
        assert welcome_data["message"] == f"Connected to notifications as {mock_user.username}"
    ...
    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    async def test_websocket_notifications_auth_error(self, mock_auth, mock_websocket, mock_db_session):
    ...
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.datetime')
    async def test_websocket_notifications_unknown_message(self, mock_datetime, mock_auth, mock_websocket, mock_user, mock_db_session):
    ...
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.datetime')
    async def test_websocket_notifications_json_error(self, mock_datetime, mock_auth, mock_websocket, mock_user, mock_db_session):
    ...
    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    async def test_websocket_notifications_general_error(self, mock_auth, mock_websocket, mock_db_session):
        ...
        mock_websocket.close.assert_called_once_with(code=1011, reason="Internal error: Connection error")

    @pytest.mark.asyncio
    @patch('app.websockets.router.get_current_user_ws')
    @patch('app.websockets.router.datetime')
    async def test_websocket_notifications_empty_loop(self, mock_datetime, mock_auth, mock_websocket, mock_user, mock_db_session):
        ...
        mock_websocket.receive_text.side_effect = Exception("Connection closed immediately")
