...
class TestServerManagementRouter:
    ...
    async def test_create_server_general_exception(self, mock_server_service, mock_auth_service, admin_user):
        ...
        mock_server_service.create_server = AsyncMock(side_effect=Exception("Database error"))
        ...
        with pytest.raises(HTTPException) as exc_info:
            await create_server(request=request, background_tasks=BackgroundTasks(), current_user=admin_user, db=Mock())
    ...
    async def test_list_servers_exception(self, mock_server_service, admin_user):
        ...
        mock_server_service.list_servers.side_effect = Exception("Database connection failed")
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_get_server_not_found(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_get_server_general_exception(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @pytest.mark.asyncio
    @patch('app.servers.routers.management.server_service')
    async def test_list_servers_admin_vs_user_access(self, mock_server_service, admin_user, test_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_create_server_conflict_exception_passthrough(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_get_server_http_exception_passthrough(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_get_server_success(self, mock_server_service, mock_auth_service, admin_user):
    ...
    async def test_update_server_success(self, mock_minecraft_manager, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.server_service')
    @patch('app.servers.routers.management.minecraft_server_manager')
    async def test_update_server_running_memory_change(self, mock_minecraft_manager, mock_server_service, mock_auth_service, admin_user):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await update_server(server_id=1, request=request, current_user=admin_user, db=Mock())
    ...
    async def test_update_server_not_found(self, mock_server_service, mock_auth_service, admin_user):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await update_server(server_id=999, request=request, current_user=admin_user, db=Mock())
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_update_server_general_exception(self, mock_server_service, mock_auth_service, admin_user):
        ...
        mock_auth_service.check_server_access.return_value = None
        # Mock server service to raise exception
        mock_server_service.update_server = AsyncMock(side_effect=Exception("Update failed"))
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_delete_server_success(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_delete_server_not_found(self, mock_server_service, mock_auth_service, admin_user):
    ...
    @patch('app.servers.routers.management.authorization_service')
    @patch('app.servers.routers.management.server_service')
    async def test_delete_server_general_exception(self, mock_server_service, mock_auth_service, admin_user):
        ...
        mock_auth_service.check_server_access.return_value = None
        # Mock server service to raise exception
        mock_server_service.delete_server = AsyncMock(side_effect=Exception("Delete failed"))
