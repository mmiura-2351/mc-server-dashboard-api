...
class TestAuthorizationServicePhase2Visibility:
    ...
    def test_check_server_access_with_public_visibility(self, db: Session, test_user, sample_server):
    ...
    def test_check_server_access_with_role_based_visibility_sufficient_role(self, db: Session, test_user, sample_server):
    ...
    def test_check_server_access_with_role_based_visibility_insufficient_role(self, db: Session, test_user, sample_server):
    ...
    def test_check_server_access_with_specific_users_visibility_granted(self, db: Session, test_user, sample_server):
    ...
    def test_check_server_access_with_specific_users_visibility_not_granted(self, db: Session, test_user, sample_server):
    ...
    def test_backup_access_follows_server_visibility(self, db: Session, test_user, sample_server):
    ...
    def test_filter_servers_with_mixed_visibility(self, db: Session, test_user, admin_user):
        ...
        filtered_servers = AuthorizationService.filter_servers_for_user(test_user, all_servers, db)
        ...
        admin_filtered_servers = AuthorizationService.filter_servers_for_user(admin_user, all_servers, db)
    ...
    def test_role_hierarchy_in_visibility(self, db: Session, sample_server):
        ...
        assert sample_server.owner_id not in [admin_user.id, operator_user.id, regular_user.id]
