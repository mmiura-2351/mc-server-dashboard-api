...
class TestJavaCompatibilityServiceMissingCoverage:
    ...
    async def test_discover_java_installations_configured_path_mismatch(self, service):
        ...
        with patch.object(service, '_detect_java_at_path') as mock_detect, \
            ...
            with patch('app.services.java_compatibility.settings') as mock_settings:
                mock_settings.get_java_path.side_effect = lambda v: "/configured/java17" if v == 17 else ""
    ...
    async def test_discover_java_installations_openjdk_fallback(self, service):
        ...
        with patch.object(service, '_detect_java_at_path') as mock_detect, \
            ...
            java17_openjdk = JavaVersionInfo(17, 0, 1, "OpenJDK", "", "/usr/lib/jvm/java-17/bin/java")
    ...
    async def test_discover_openjdk_installations_comprehensive(self, service):
        ...
        with patch('os.path.exists') as mock_exists, \
            ...
            java17 = JavaVersionInfo(17, 0, 1, "OpenJDK", "openjdk version", "/usr/lib/jvm/java-17/bin/java")
            java8 = JavaVersionInfo(8, 0, 292, "OpenJDK", "openjdk version", "/usr/lib/jvm/java-8/bin/java")
            java21 = JavaVersionInfo(21, 0, 1, "OpenJDK", "openjdk version", "/opt/java/openjdk-21/bin/java")
    ...
    def test_validate_java_compatibility_exception_handling(self, service):
        ...
        with patch.object(service, 'get_required_java_version', side_effect=Exception("Version error")):
            compatible, message = service.validate_java_compatibility("1.18.0", java17)
    ...
    def test_generate_compatibility_error_message_all_java_versions(self, service):
        ...
        assert "Download Java 8: https://adoptium.net/temurin/releases/?version=8" in message8
        ...
        assert "Download Java 16: https://adoptium.net/temurin/releases/?version=16" in message16
        ...
        assert "Download Java 17: https://adoptium.net/temurin/releases/?version=17" in message17
        ...
        assert "Download Java 21: https://adoptium.net/temurin/releases/?version=21" in message21
