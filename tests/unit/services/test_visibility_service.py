...
from app.core.visibility import ResourceType, ResourceVisibility, ResourceUserAccess, VisibilityType
...
class TestVisibilityServiceResourceAccess:
    ...
    def test_public_visibility_access(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_private_visibility_access_denied(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_role_based_visibility_user_access(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_role_based_visibility_operator_access(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_role_based_visibility_no_restriction(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_specific_users_visibility_granted_access(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_specific_users_visibility_no_grant_access_denied(self, visibility_service, test_user, sample_resource_visibility):
    ...
    def test_no_visibility_config_defaults_to_private(self, visibility_service, test_user):
...
class TestVisibilityServiceResourceFiltering:
    ...
    def test_filter_resources_by_visibility_public(self, visibility_service, test_user, db):
    ...
    def test_filter_resources_by_visibility_owner(self, visibility_service, test_user, db):
...
class TestVisibilityServiceManagement:
    ...
    def test_set_resource_visibility_clears_user_grants(self, visibility_service, test_user, db):
        ...
        remaining_grants = db.query(ResourceUserAccess).filter(
    ...
    def test_grant_user_access_wrong_visibility_type(self, visibility_service, test_user, db):
    ...
    def test_get_resource_visibility_info_public(self, visibility_service, db):
        ...
        info = visibility_service.get_resource_visibility_info(
    ...
    def test_get_resource_visibility_info_specific_users(self, visibility_service, test_user, db):
...
class TestVisibilityServiceEdgeCases:
    ...
    def test_unknown_visibility_type_handling(self, visibility_service, test_user, db):
        ...
        visibility.visibility_type = "unknown_type"  # This would fail enum validation in real scenario
        ...
        assert has_access is False  # Should deny access with unknown visibility type (secure default)
    ...
    def test_role_hierarchy_edge_cases(self, visibility_service, db):
        ...
        operator_user = User(id=2, role=Role.operator, username="operator", email="operator@test.com")
        ...
        # Test role hierarchy
        assert visibility_service.check_resource_access(admin_user, ResourceType.SERVER, 1, 999) is True
        assert visibility_service.check_resource_access(operator_user, ResourceType.SERVER, 1, 999) is True
        assert visibility_service.check_resource_access(regular_user, ResourceType.SERVER, 1, 999) is False
