...
class TestMinecraftAPIService:
    ...
    def test_service_constants(self):
        ...
        assert MinecraftAPIService.MOJANG_SESSION_API == "https://sessionserver.mojang.com"
    ...
    async def test_get_username_from_uuid_success(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            result = await MinecraftAPIService.get_username_from_uuid("853c80ef-3c37-49fd-aa49-938b674adae6")
    ...
    async def test_get_username_from_uuid_without_dashes(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            result = await MinecraftAPIService.get_username_from_uuid("853c80ef3c3749fdaa49938b674adae6")
    ...
    async def test_get_username_from_uuid_not_found(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            result = await MinecraftAPIService.get_username_from_uuid("00000000-0000-0000-0000-000000000000")
    ...
    async def test_get_username_from_uuid_malformed_response(self):
        ...
        mock_response_data = {"id": "853c80ef3c3749fdaa49938b674adae6"}  # Missing 'name' field
    ...
    @pytest.mark.parametrize("username,expected_uuid_type", [
        ("Notch", str),
        ("jeb_", str),
        ("Dinnerbone", str),
        ("_test_", str),
