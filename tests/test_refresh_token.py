...
class TestRefreshTokenAPI:
    ...
    def test_refresh_token_success(self, client: TestClient, test_user: User, db: Session):
    ...
    def test_refresh_token_revoked_after_logout(self, client: TestClient, test_user: User, db: Session):
