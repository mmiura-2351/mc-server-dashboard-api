...
3. **Immediate Branch Cleanup**: Delete branches immediately after PR close/merge using `git branch -D branch-name` to maintain repository cleanliness
...
4. **Post-Merge Cleanup**: Always delete the branch immediately after closing/merging PR
