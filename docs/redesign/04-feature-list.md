...
| サーバーユーティリティ | 6 | [specs/03-servers.md](specs/03-servers.md) |
| インポート/エクスポート | 2 | [specs/03-servers.md](specs/03-servers.md) |
...
| テンプレート (Templates) | 8 | [specs/06-templates.md](specs/06-templates.md) |
| ファイル管理 (Files) | 9 | [specs/07-files.md](specs/07-files.md) |
| ファイル編集履歴 | 5 | [specs/07-files.md](specs/07-files.md) |
| リアルタイム通信 (WebSocket) | 3 | [specs/08-realtime.md](specs/08-realtime.md) |
| 監査ログ (Audit) | 4 | [specs/09-audit.md](specs/09-audit.md) |
| 可視性制御 (Visibility) | 6 | [specs/09-audit.md](specs/09-audit.md) |
| **合計** | **101** | - |
...
| 9 | POST | `/backups/{backup_id}/restore-with-template` | User | バックアップ復元 + テンプレート生成 |
...
| ServerConfiguration | server_configurations | [specs/03-servers.md](specs/03-servers.md) |
...
| Template | templates | [specs/06-templates.md](specs/06-templates.md) |
...
| ResourceVisibility | resource_visibility | [specs/09-audit.md](specs/09-audit.md) |
| ResourceUserAccess | resource_user_access | [specs/09-audit.md](specs/09-audit.md) |
